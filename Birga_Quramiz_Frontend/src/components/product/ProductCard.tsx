        ...
        <div className="h-max w-full mt-auto ">
          {quantity > 0 ? (
            <div
              ...
              className="w-full h-10 rounded-2xl bg-[#275fdb] flex items-center overflow-hidden"
            >
              <button
                onClick={handleDecrement}
                className="flex-none w-10 h-full flex items-center justify-center text-white active:opacity-70"
              >
