    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="relative lg:hidden">
        ...
        <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-3 pt-3">
          ...
          <button
            onClick={() => router.back()}
            className="flex items-center justify-center rounded-xl bg-white/75 backdrop-blur-md"
      ...
      {/* ── Mobile content ── */}
      <div className="lg:hidden flex flex-col gap-1 pb-[130px] bg-[#e8e8ed] px-[6px] pt-1">
      ...
      <div className="lg:hidden fixed bottom-[60px] left-0 right-0 z-40 bg-white border-t border-[#ebebeb] px-4 pt-2 pb-4 flex flex-col gap-2">
        ...
        <div className="flex items-center">
          <span className="text-[13px] font-bold text-[#242424] leading-none">
            {product.price.toLocaleString("ru-RU")}
            <span className="text-[12px] font-medium text-[#888] ml-1">{t("currencyUzs")}</span>
          </span>
